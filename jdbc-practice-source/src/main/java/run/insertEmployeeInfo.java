...
public class insertEmployeeInfo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.print("등록할 직원의 id를 입력하세요 : ");
            emp.setEmpId(sc.nextLine());

            System.out.print("등록할 직원의 이름을 입력하세요 : ");
            emp.setEmpName(sc.nextLine());

            System.out.print("등록할 직원의 번호를 입력하세요 : ");
            emp.setEmpNo(sc.nextLine());

            System.out.print("등록할 직원의 이메일을 입력하세요 : ");
            emp.setEmail(sc.nextLine());

            System.out.print("등록할 직원의 전화번호를 입력하세요 : ");
            emp.setPhone(sc.nextLine());

            System.out.print("등록할 직원의 부서 번호를 입력하세요 : ");
            emp.setDeptCode(sc.nextLine());

            System.out.print("등록할 직원의 직급 번호을 입력하세요 : ");
            emp.setJobCode(sc.nextLine());

            System.out.print("등록할 직원의 급여 레벨을 입력하세요 : ");
            emp.setSalLevel(sc.nextLine());

            System.out.print("등록할 직원의 급여를 입력하세요 : ");
            emp.setSalary(sc.nextInt());

            System.out.print("등록할 직원의 보너스를 입력하세요 : ");
            emp.setBonus(sc.nextDouble());

            System.out.print("등록할 직원의 매니저 id를 입력하세요 : ");
            sc.nextLine();
            emp.setManagerId(sc.nextLine());

            System.out.print("등록할 직원의 hireDate를 입력하세요 (yyyy-MM-dd) : ");
            hireDate = java.sql.Date.valueOf(sc.nextLine());
            emp.setHireDate(hireDate);

            System.out.print("등록할 직원의 entDate을 입력하세요 (yyyy-MM-dd) : ");
            entDate = java.sql.Date.valueOf(sc.nextLine());
            emp.setEntDate(entDate);

            System.out.print("등록할 직원의 entYn을 입력하세요 : ");
